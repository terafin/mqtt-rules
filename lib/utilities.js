...
exports.parseTime = function(timeString) {
    ...
    if (timeString.includes(':')) {
        ...
        if (timeKey === 'sunrise') {
            ...
            date = times.sunset
        } else if (timeKey === 'sunriseEnd') {
            date = times.sunriseEnd
        } else if (timeKey === 'sunsetStart') {
            date = times.sunsetStart
        } else if (timeKey === 'nadir') {
            date = times.nadir
        } else if (timeKey === 'dusk') {
            date = times.dusk
        } else if (timeKey === 'dawn') {
            date = times.dawn
        } else if (timeKey === 'night') {
            date = times.night
        } else if (timeKey === 'nightEnd') {
            date = times.nightEnd
        } else if (timeKey === 'goldenHour') {
            date = times.goldenHour
        } else if (timeKey === 'goldenHourEnd') {
            date = times.goldenHourEnd
